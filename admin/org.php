...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" integrity="sha512-MV7K8+y+gLIBoVD59lQIYicR65iaqukzvf/nwasF0nqhPay5w/9lJmVM2hMDcnK1OnMGCdVK+iQrJ7lzPJQd1w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  ...
  <body>
	...
	<div class="container mt-2 mb-4 p-2 shadow ">
		...
		<form action="crud_org.php" method="POST" enctype="multipart/form-data">
	...
	// select query
	$result=mysqli_query($conn,"SELECT * FROM user where profil='org' ") or die("erreur");
	?>
			...
			while($ligne=mysqli_fetch_array($result,MYSQLI_BOTH)){ ?>
				...
				<tr>
					...
					<td style="width: 10%">
						...
						<a href="org.php?modifier=<?php echo $ligne['id']; ?>" title="Modification enregistrement" data-toggle="tooltip"><span class="fa fa-pencil-alt"></span></a>
						<a href="crud_org.php?supprimer=<?php echo $ligne['id']; ?>" title="Suppression enregistrement" data-toggle="tooltip"><span class="fa fa-trash"></span></a>
					</td>
				</tr>
			<?php } ?>	
			</tbody>	
